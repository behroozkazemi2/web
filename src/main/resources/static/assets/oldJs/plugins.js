...
!function (e, t) {
    ...
    return o.prototype.addElementBackgroundImages = function (e) {
        ...
        this.proxyImage.removeEventListener("load", this), this.proxyImage.removeEventListener("templates.view.error", this), this.img.removeEventListener("load", this), this.img.removeEventListener("templates.view.error", this)
    }, s.prototype = Object.create(r.prototype), s.prototype.check = function () {
        this.img.addEventListener("load", this), this.img.addEventListener("templates.view.error", this), this.img.src = this.url;
        var e = this.getIsImageComplete();
        e && (this.confirm(0 !== this.img.naturalWidth, "naturalWidth"), this.unbindEvents())
    }, s.prototype.unbindEvents = function () {
        this.img.removeEventListener("load", this), this.img.removeEventListener("templates.view.error", this)
...
(function (c) {
    c.fn.bPopup = function (A, E) {
        ...
        var b = this, f = c(document), k = c(window), y = k.height(), w = k.width(),
            N = /OS 6(_\d)+/i.test(navigator.userAgent), v = 0, e, h, q, n, g, z, x, t, u, J, H;
        b.close = function () {
            r()
        };
            ...
            form.submit(function () {
                ...
                function successCallback(resp) {
                    if (resp.result === "success") {
                        ...
                        label.removeClass("templates.view.error").addClass("valid");
                        email.removeClass("templates.view.error").addClass("valid")
                    } else {
                        email.removeClass("valid").addClass("templates.view.error");
                        label.removeClass("valid").addClass("templates.view.error");
                        var index = -1;
                        try {
